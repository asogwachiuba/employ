...
import '../language/edit_resume_language.dart';

class EditResumeSkills extends StatefulWidget {
  const EditResumeSkills({Key? key}) : super(key: key);

  @override
  State<EditResumeSkills> createState() => _EditResumeSkillsState();
}
...
class _EditResumeSkillsState extends State<EditResumeSkills> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  SvgPicture.asset(CIcon.skillsIcon, width: 25,),
                  SizedBox(width: 20,),
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          CFont.darkSecondary('Project Management'),
                          SizedBox(height: 5,),
                          CFont.small("Expert"),
                        ],),
                      Spacer(flex: 1,),
            ...
            GestureDetector(
              onTap: () {_navigateToEditResumeEducation(context,SkillsEditForm());},
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                child: Container(
                  height: 80,
            ...
            // next button
            CButton.primary(text: 'Next', onPressed: () {_navigateToEditResumeEducation(context, const EditResumeLanguage());})
          ],
        ),
      ),
    );
