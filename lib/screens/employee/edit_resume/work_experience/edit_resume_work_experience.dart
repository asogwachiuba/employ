...
import '../education/edit_resume_education.dart';

class EditResumeWorkExperience extends StatefulWidget {
  const EditResumeWorkExperience({Key? key}) : super(key: key);

  @override
  State<EditResumeWorkExperience> createState() => _EditResumeWorkExperienceState();
}
...
void _navigateToEditResumeEducation(BuildContext context,Widget widget) {
  Navigator.push(
      context,
      PageTransition(
...
class _EditResumeWorkExperienceState extends State<EditResumeWorkExperience> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      children: [
                        CFont.darkSecondary('Product Manager'),
                        SizedBox(height: 5,),
                        CFont.small("Apple"),
                      ],),
                      Spacer(flex: 1,),
            ...
            GestureDetector(
              onTap: () {
                _navigateToEditResumeEducation(context,WorkExperienceEditForm());
              },
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20.0),
                child: Container(
            ...
            // next button
            CButton.primary(text: 'Next', onPressed: () {_navigateToEditResumeEducation(context,EditResumeEducation());})
          ],
        ),
      ),
    );
